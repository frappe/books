...
const itemPriceMap = {
  ...
  itemPriceThree: {
    ...
    selling: true,
    party: partyMap.partyOne.name,
    validFrom: '2023-01-03T18:30:00.000Z',
  ...
  itemPriceFive: {
    ...
    item: itemMap.Pen.name,
    rate: 104,
    priceList: priceListMap.PL_D.name,
    buying: true,
    selling: true,
    party: partyMap.partyOne.name,
    validFrom: '2023-03-01T05:49:49.678Z',
  ...
  itemPriceSix: {
    ...
    selling: true,
    party: partyMap.partyOne.name,
    validFrom: '2023-03-31T18:30:00.000Z',
    validUpto: '2023-04-09T18:30:00.000Z',
    ...getDefaultMetaFieldValueMap(),
  },
};
