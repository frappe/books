  ...
  'sendMail': async function (mailDetails) {
    ...
    for (var i = 0; i < account.length; i++) {
      if (mailDetails.fromEmailAddress == account[i].email) {
        var mailKey = "Sent to : " + mailDetails.toEmailAddress + " cc: " + mailDetails.ccEmailAddress + " bcc: " + mailDetails.bccEmailAddress + " " + mailDetails.subject.slice(0, 10); // needs change : THINK
        mailDetails = {
