...
export default defineComponent({
  ...
  methods: {
    setShortcuts() {
      ...
      this.shortcuts.ctrl.set(this.context, ['Equal'], zoomIn);
      this.shortcuts.ctrl.shift.set(this.context, ['Equal'], zoomIn);
      this.shortcuts.ctrl.set(this.context, ['NumpadAdd'], zoomIn);

      this.shortcuts.ctrl.set(this.context, ['Minus'], zoomOut);
