export default {
  ...
  template: `
    ...
    <div class="row py-4">
        <div class="col-6">
            <div><b>{{ frappe.t("Customer") }}</b></div>
            <div>{{ doc.customer }}</div>
        </div>
        <div class="col-6">
            <div><b>{{ frappe.t("Date") }}</b></div>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th>{{ frappe.t("Item") }}</th>
                <th class='text-right'>{{ frappe.t("Qty") }}</th>
                <th class='text-right'>{{ frappe.t("Rate") }}</th>
                <th class='text-right'>{{ frappe.t("Amount") }}</th>
            </tr>
        </thead>
        <tbody>
